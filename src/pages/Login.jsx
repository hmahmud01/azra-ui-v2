        ...
        <section id="wrapper" className="login-register login-sidebar">
            <div className="login-box card">
                <div className="card-body">
                    <form className="floating-labels" id="frm_login" method="POST">
                        ...
                        <div className="form-group m-b-40">
                            <input type="text" className="form-control" id="username" required /><span className="bar"></span>
                            <label for="username">Username</label>
                        </div>
                        <div classname="form-group m-b-40">
                            <input type="password" className="form-control" id="password" required /><span className="bar"></span>
